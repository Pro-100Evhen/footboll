    ...
    <FooterBg>
      <FooterContainer>
        ...
        <Disclaimer>
            ...
            >
              <g clipPath="url(#clip0_4001_1010)">
                ...
                <g mask="url(#mask0_4001_1010)">
                  <path
                    d="M15.8231 33.7059V20.1313H12.6851V16.6526H20.1533V33.7059H15.8231Z"
                    fill="white"
                  />
                  <path
                    d="M36.4275 21.0558C36.4275 22.5397 35.6247 23.8533 34.2868 24.5832C36.1598 25.3616 37.3275 26.9916 37.3275 28.889C37.3275 31.9541 34.6028 33.9003 30.3458 33.9003C26.0885 33.9003 23.364 31.9784 23.364 28.9621C23.364 27.0159 24.6289 25.3616 26.5994 24.5832C25.1642 23.7803 24.2397 22.4182 24.2397 20.9343C24.2397 18.2095 26.6239 16.4824 30.3214 16.4824C34.0677 16.4824 36.4275 18.2583 36.4275 21.0558ZM27.4508 28.5242C27.4508 29.9596 28.4727 30.7624 30.3458 30.7624C32.2189 30.7624 33.2649 29.9841 33.2649 28.5242C33.2649 27.1134 32.2189 26.3104 30.3458 26.3104C28.4725 26.3104 27.4508 27.1134 27.4508 28.5242ZM27.8889 21.2991C27.8889 22.5156 28.7646 23.1965 30.3458 23.1965C31.927 23.1965 32.8028 22.5155 32.8028 21.2991C32.8028 20.0344 31.927 19.3287 30.3458 19.3287C28.7644 19.3287 27.8889 20.0344 27.8889 21.2991Z"
                    fill="white"
                  />
                  <path
                    d="M44.5329 18.5778C45.2527 20.7025 45.6179 22.9249 45.6179 25.1915C45.6179 36.5567 36.3715 45.8031 25.0061 45.8031C13.6408 45.8031 4.39422 36.5567 4.39422 25.1915C4.39422 13.8259 13.6407 4.57986 25.006 4.57986C27.2729 4.57986 29.4953 4.94475 31.6197 5.66496V1.07809C29.4738 0.489859 27.2575 0.191406 25.0061 0.191406C11.2212 0.191406 0.00622559 11.4064 0.00622559 25.1915C0.00622559 38.9766 11.2212 50.1916 25.0061 50.1916C38.791 50.1916 50.0059 38.9766 50.0059 25.1915C50.0059 22.9402 49.7076 20.7238 49.1194 18.5778H44.5329Z"
                    fill="white"
                  />
                  <path
                    d="M43.2855 6.89813V2.10449H39.8385V6.89813H35.0736V10.3449H39.8385V15.1384H43.2855V10.3449H48.0788V6.89813H43.2855Z"
                    fill="white"
                  />
                </g>
              </g>
              <defs>
                <clipPath id="clip0_4001_1010">
                  <rect
                    ...
                    height="50"
                    fill="white"
                    transform="translate(0.00622559 0.191406)"
                  />
                </clipPath>
              </defs>
            </svg>
          ...
          <div style={{ marginBottom: 12 }}>
            Fantasy Cricket Arena offers fantasy sports for entertainment. These games are not for
            employment or income. Play within your means and understand the risks. The platform is
            not liable for any issues arising from gameplay.
          </div>
          ...
          <div style={{ marginTop: 8, fontSize: 12 }}>
            © 2024 fantasysportsindia. All Rights Reserved.
          </div>
        </Disclaimer>
      </FooterContainer>
    </FooterBg>
